...
```R
paleomass(Folder = "Plesiopterys", body.axis.l = 2.94, 
	ffin.onset = 0.45, ffin.adj.up = 50, ffin.adj.lat = -75, ffin.pitch = pi/6, ffin.roll = pi/3,
	hfin.onset = 0.65, hfin.adj.up = 50, hfin.adj.lat = -175, hfin.pitch =  pi/7, hfin.roll = pi/4)
```
...
```R
paleomass(Folder = "Plesiopterys", Test.Run=T)
```
